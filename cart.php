...
<script>
var init_url = document.URL.split('/')
var i= 4;
var pdp_name = ''
for(i; i <=init_url.length-1; i += 1) {
    pdp_name+=init_url[i];
    pdp_name+=':';
}
pdp_name = pdp_name.replace('.php:','');
digitalData = window.dataLayer || [];
digitalData.page = {'pageName': pdp_name};



if (init_url[4] != undefined) {
  var sitesectionname = init_url[4]
  sitesectionname = sitesectionname.replace('.php','');
  digitalData.page.siteSection = sitesectionname;
  }



if (init_url[5] != undefined) {
  var sitesubsectionname = init_url[5]
  sitesubsectionname = sitesubsectionname.replace('.php','');
  digitalData.page.siteSubsection = sitesubsectionname;
  }
</script>
